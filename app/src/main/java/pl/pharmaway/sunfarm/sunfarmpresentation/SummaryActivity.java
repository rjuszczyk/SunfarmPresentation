...
public class SummaryActivity extends MotylActivity {
    ...
    protected void onResume() {
        super.onResume();
        AnimationUtil.animateInFromCenter(this.summary_img_left, 1 * animationLength, animationDuration);
        AnimationUtil.animateInFromCenter(this.diorin_right_img, 2 * animationLength, animationDuration);
        AnimationUtil.animateInFromCenter(this.summary_bottom_img, 3 * animationLength, animationDuration);
    }
}
